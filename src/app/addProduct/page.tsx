...
import { AppProductSchema } from "@/schema/addProducts";
...
const AddProduct = () => {
  ...
  const {
    ...
    resolver: yupResolver(AppProductSchema),
  });
    ...
    <div className="py-7">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        {errors.name && typeof errors.name.message === "string" && (
          <div className="text-red-700 text-center">{errors.name.message}</div>
        )}
        <div className="text-center">
        ...
        {errors.price && typeof errors.price.message === "string" && (
          <div className="text-red-700 text-center">{errors.price.message}</div>
        )}
